...
foreground_gene_file<-"./data/GM12878_trans_res_CAGE_top_hub_entrez_tbl.Rda"

top_hub_file<-"~/Documents/multires_bhicect/Bootstrapp_fn/data/DAGGER_tbl/trans_res/HMEC_union_top_trans_res_dagger_tbl.Rda"

out_file<-"./data/trans_res_hub_GS_tbl/GM12878_trans_res_top_hub_entrez_GOBP_enrich_tbl.Rda"
...
write_tsv(path_tbl %>% 
            filter(FDR<=0.01) %>% 
            arrange(desc(OR)), file = "~/Downloads/HMEC_top_hub_GO_enrich_results.tsv")
