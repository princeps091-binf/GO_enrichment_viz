...
foreground_gene_file<-"./data/GM12878_5kb_top_compound_hub_ENSG_tbl.Rda"

out_file<-"./data/GM12878_5kb_compound_top_hub_GOBP_enrich_tbl.Rda"
...
foreground_gene_vec<-foreground_gene_tbl %>% dplyr::select(ENSG.content) %>% 
